...
const ReportDashboard = () => {
  ...
  // const today = "2026-08-23"; // Hardcoded for testing
  ...
  const handleTranslate = async (feedback) => {
    if (!feedback.transcript || translating[feedback._id]) {
      return;
    }
    ...
    try {
      ...
      const translation =
        response?.data?.english_translation;
